...
@Slf4j
public class TargetHttpHandler extends NatCommonHandler {

    private Channel proxyChannel;

    public TargetHttpHandler(Channel proxyChannel) {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        try {
            ...
            log.info("Write HTTP message back to proxy channel: {}, {} bytes", proxyChannel, byteBuf.readableBytes());
